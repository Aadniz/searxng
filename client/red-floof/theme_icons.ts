...
/**
 * Generate icons.html for the jinja templates of the red-floof theme.
 */
...
const dest: string = resolve(HERE, "../../searx/templates/red-floof/icons.html");
...
jinja_svg_sets(dest, searxng_jinja_macros, red_floof_icons);
