...
const PATH = {
  ...
  dist: resolve(ROOT, "searx/static/themes/red-floof"),
  // dist: resolve(ROOT, "client/red-floof/dist"),

  src: "src",
  modules: "node_modules",
  brand: "src/brand",
  static: resolve(ROOT, "client/red-floof/static"),
  leaflet: resolve(ROOT, "client/red-floof/node_modules/leaflet/dist"),
  templates: resolve(ROOT, "searx/templates/red-floof"),
};
